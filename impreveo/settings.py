"""
Django settings for impreveo project.
...
SECRET_KEY = 'django-insecure-bnr66(o_kb^-@myaj)^j8@6zad+#pi2k78_as%=qlk34=$@ow0'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'profiles.context_processors.profilePicView',
                'profiles.context_processors.getProfileView'
            ],
        },
    },
]
